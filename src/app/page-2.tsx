...
export default function Home() {
    ...
    const features = [
        {
            icon: '💘',
            title: '甜蜜技术栈',
            description: '基于Next.js、Tailwind CSS等最新技术打造，为你们的爱情故事提供完美舞台'
        },
        {
            icon: '⚡',
            title: '心跳加速加载',
            description: '优化加载速度，让你们的甜蜜回忆如初恋般瞬间涌现'
        },
        {
            icon: '📱',
            title: '爱的全适配',
            description: '从手机到平板，随时随地重温你们的浪漫时刻'
        },
        {
            icon: '🎨',
            title: '双人主题定制',
            description: '提供情侣配色和主题，打造专属你们的爱情空间'
        },
        {
            icon: '📖',
            title: '爱情故事模板',
            description: '简单填充恋爱故事，自动生成精美爱情纪念册'
        },
        {
            icon: '💝',
            title: '免费爱心传递',
            description: 'MIT许可证授权，让爱在开发者社区中传递'
        }
    ];

    const stats = [
        { label: '相爱天数', value: '365+' },
        { label: '共同回忆', value: '100+' },
        { label: '约会次数', value: '52' },
        { label: '未来计划', value: '永远' },
    ];
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-pink-50 to-rose-100">
            <Head>
                <title>LoveSpace | 情侣纪念空间</title>
                <meta name="description" content="记录爱情点滴的浪漫空间" />
                    ...
                    <div className="flex items-center justify-between h-16">
                        <div className="flex-shrink-0 flex items-center">
                            ...
                            <h1 className="ml-3 text-xl font-bold text-gray-800">
                                Love<span className="text-rose-500">Space</span>
                            </h1>
                        </div>

                        <div className="hidden md:flex space-x-8">
                            <a href="#" className="text-gray-600 hover:text-rose-500 font-medium">爱的主页</a>
                            <a href="#" className="text-gray-600 hover:text-rose-500 font-medium">恋爱功能</a>
                            <a href="#" className="text-gray-600 hover:text-rose-500 font-medium">纪念模板</a>
                            <a href="#" className="text-gray-600 hover:text-rose-500 font-medium">使用指南</a>
                            <a href="#" className="text-gray-600 hover:text-rose-500 font-medium">甜蜜示例</a>
                        </div>
            ...
            <main className="pt-24 pb-16">
                ...
                <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center mb-20">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-800 mb-6 leading-tight">
                            创建专属<span className="text-rose-500">爱情空间</span>
                        </h1>

                        <p className="text-xl text-gray-600 max-w-2xl mx-auto mb-10">
                            记录你们爱情旅程的每一个珍贵瞬间，专为情侣设计的浪漫空间
                        </p>
                ...
                <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-20">
                    <div className="bg-white rounded-2xl shadow-lg p-10 glass-card">
                        <h2 className="text-3xl font-bold text-center text-gray-800 mb-16">爱的技术栈</h2>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            <div className="tech-card">
                                ...
                                <p className="text-gray-600 text-sm mt-1">构建爱的框架</p>
                            </div>
                            ...
                            <div className="tech-card">
                                ...
                                <p className="text-gray-600 text-sm mt-1">装扮爱的空间</p>
                            </div>
                            ...
                            <div className="tech-card">
                                ...
                                <p className="text-gray-600 text-sm mt-1">编写爱的代码</p>
                            </div>
                            ...
                            <div className="tech-card">
                                ...
                                <h3 className="font-bold text-lg">爱的响应</h3>
                                <p className="text-gray-600 text-sm mt-1">随时随地访问</p>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-20">
                    <div className="flex justify-center mb-16">
                        <h2 className="text-3xl font-bold text-gray-800">甜蜜功能</h2>
                    </div>
                    ...
                    <div className="bg-gradient-to-r from-rose-500 to-pink-600 rounded-3xl p-1">
                        <div className="bg-white rounded-[22px] p-12">
                            ...
                            <div className="max-w-2xl mx-auto mt-16">
                                <h3 className="text-2xl font-bold text-center mb-6">为什么选择 LoveSpace?</h3>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="flex items-start">
                                        ...
                                        <div>
                                            <h4 className="font-semibold">快速搭建</h4>
                                            <p className="text-gray-600 text-sm">几分钟创建专属爱情空间</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-start">
                                        ...
                                        <div>
                                            <h4 className="font-semibold">浪漫体验</h4>
                                            <p className="text-gray-600 text-sm">精心设计的动画和交互效果</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-start">
                                        ...
                                        <div>
                                            <h4 className="font-semibold">专属装扮</h4>
                                            <p className="text-gray-600 text-sm">多种情侣主题和配色方案</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-start">
                                        ...
                                        <div>
                                            <h4 className="font-semibold">回忆管理</h4>
                                            <p className="text-gray-600 text-sm">轻松记录和整理恋爱故事</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <footer className="bg-gray-900 text-white py-16">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        <div>
                            <div className="flex items-center mb-6">
                                ...
                                <h2 className="ml-3 text-xl font-bold">Love<span className="text-rose-400">Space</span></h2>
                            </div>
                        ...
                        <div>
                            <h3 className="text-lg font-semibold mb-6">爱的空间</h3>
                            <ul className="space-y-3">
                                <li><a href="#" className="text-gray-400 hover:text-white">恋爱功能</a></li>
                                <li><a href="#" className="text-gray-400 hover:text-white">纪念模板</a></li>
                                <li><a href="#" className="text-gray-400 hover:text-white">甜蜜示例</a></li>
                        ...
                        <div>
                            <h3 className="text-lg font-semibold mb-6">恋爱支持</h3>
                            <ul className="space-y-3">
                                <li><a href="#" className="text-gray-400 hover:text-white">常见问题</a></li>
                                <li><a href="#" className="text-gray-400 hover:text-white">情侣社区</a></li>
                        ...
                        <div>
                            <h3 className="text-lg font-semibold mb-6">订阅甜蜜</h3>
                            <p className="text-gray-400 mb-4">获取最新情侣空间模板和功能更新</p>
                            <form className="flex">
                                <input
                                    type="email"
                                    placeholder="你们的爱情邮箱"
                    ...
                    <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
                        <p className="text-gray-400">© {new Date().getFullYear()} LoveSpace. 让爱永存.</p>
